<?php
namespace App\Http\Resources\NewsSettings;

use App\Models\NewsSubnavigation;
use Illuminate\Http\Resources\Json\JsonResource;

class NewsSettingUpdateResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'show_footer_articles' => $this->show_footer_articles === null ? true : (bool)$this->show_footer_articles,
