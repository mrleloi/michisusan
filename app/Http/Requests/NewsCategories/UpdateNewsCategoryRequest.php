...
//        'show_description', 'publish_status',
    ...
    {
        return [
            'name' => ['required', 'string', new MaxFullHalfWidth(30), Rule::unique('news_categories', 'name')->ignore($this->id)],
            ...
            'show_description' => [
                'nullable',
                Rule::in([
                    NewsCategory::SHOW_DESCRIPTION_YES,
                    NewsCategory::SHOW_DESCRIPTION_NO,
                ])],
