...
class ChangeOrderNewsCategoryRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'items.*.id' => 'required|integer|exists:news_categories,id',
            'items.*.order' => 'required|integer|exists:news_categories,order',
