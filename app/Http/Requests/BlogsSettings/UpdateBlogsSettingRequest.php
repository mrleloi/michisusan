<?php
namespace App\Http\Requests\BlogsSettings;
...
class UpdateBlogsSettingRequest extends FormRequest
{
    protected $booleanFields = [
        'with_seo_title', 'show_in_header_navimenu', 'show_in_footer_navimenu', 'show_in_site_map',
        'show_sns', 'show_footer_index', 'show_archive', 'show_published_at',
        'show_updated_at'
    ];
    ...
    public function rules()
    {
        return [
            ...
            'page_title' => ['nullable', 'string', new MaxFullHalfWidth(35)],
            'description' => ['nullable', 'string', new MaxFullHalfWidth(250)],
            'h1_text' => ['nullable', 'string', new MaxFullHalfWidth(35)],
            ...
            'introduction_image' => 'nullable|integer|min:1',
    ...
    public function messages()
    {
        return [
            ...
            'page_title.App\Rules\MaxFullHalfWidth' => 'ページタイトルは30文字以内で入力してください。',
            'description.App\Rules\MaxFullHalfWidth' => '説明は120文字以内で入力してください。',
            'h1_text.App\Rules\MaxFullHalfWidth' => 'H1テキストは20文字以内で入力してください。',
            ...
            'show_footer_posts.boolean' => '記事フッター表示は真偽値である必要があります。',
            ...
            'introduction_image.App\Rules\MaxFullHalfWidth' => '紹介画像は255文字以内で入力してください。',
        ];
    }
}
