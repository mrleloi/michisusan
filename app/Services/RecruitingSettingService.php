...
use App\Models\RecruitingSettingImage;
use Auth;
use Illuminate\Support\Arr;

class RecruitingSettingService extends EmbedPartsService
{
    public function store($params)
    {
        $gi = RecruitingSetting::create($params);
    ...
    public function getCommonFooterTypes()
    {
        return [
            ['key' => '1', 'label' => '新着情報TOP・一覧表示に共通フッターを表示する'],
            ['key' => '2', 'label' => '全記事に共通フッターを表示する'],
        ];
    }
