        ...
        <div class="grid grid-cols-3">
            ...
            >
                ...
                <div
                    ...
                    :style="{ backgroundImage: `url(${'/storage/' + item.thumbnail_filename})` }" @click="showVideo(item)"
                >
                    <div
                ...
                <div v-if="isModalVisible" class="fixed inset-0 bg-black/70 flex justify-center items-center z-50">
                    <div>
                        <video controls autoplay class="min-h-[60vh] min-w-[60vw] rounded shadow-lg">
                            <source :src="enlargedVideoUrl" type="video/mp4">
...
const enlargedVideoUrl = ref('')

function showVideo(item) {
    enlargedVideoUrl.value = '/storage/' + item.filename
