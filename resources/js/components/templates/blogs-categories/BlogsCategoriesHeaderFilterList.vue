<template>
    <form method="POST" :action="props.formPath" class="flex flex-wrap items-center gap-2" id="sortable-list-main-form">
        <div class="flex gap-[12px]">
            ...
            <input type="hidden" name="blogs_category_max_view" :value="maxViewOption.value">
            <InputText v-model.trim="filledKeyword" placeholder="キーワード" class="w-[141px] h-[38px]" :value="filledKeyword" name="blogs_category_keyword"/>
