...
const props = defineProps(['tags' , 'path', 'csrfToken', 'errormessage', 'oldInput', 'backPath'])
...
const formData = reactive({
    ...
    show_description: props.oldInput?.show_description,
    h1_text: props.oldInput?.h1_text,
    publish_status: props.oldInput?.publish_status,
})
