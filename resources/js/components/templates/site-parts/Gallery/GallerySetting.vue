<template>
  <template v-if="tab === ''">
    <h1 class="pl-4 font-bold text-xl">ギャラリーデザイン</h1>
  ...
  <template v-if="tab === 'setting'">
    ...
    <div class="px-4 pt-4 pb-4 border-b">
      ...
      <div class="p-8 pt-4 border-b">
        <h1 class="font-bold pb-4">内容文の表示</h1>
        <div class="flex gap-4 flex-wrap">
          <div class="flex items-center">
            <RadioButton
        ...
        <div class="flex gap-4 flex-wrap">
          <div class="flex items-center">
            <RadioButton
              ...
              inputId="category_divided_show_type"
              name="showType"
              value="cd"
            />
            <label for="category_divided_show_type" class="ml-2 cursor-pointer">
              カテゴリーで分けて表示
            </label>
          </div>
          <div class="flex items-center">
            <RadioButton
              v-model="attributes.showType"
              inputId="not_category_divided_show_type"
              name="showType"
              value="ncd"
            />
            <label
              for="not_category_divided_show_type"
          ...
          <div class="flex items-center">
            <RadioButton
              v-model="attributes.showType"
              inputId="singled_show_type"
              name="showType"
              value="s"
            />
            <label for="singled_show_type" class="ml-2 cursor-pointer">
              1件表示
            </label>
          </div>
        </div>
      ...
      <div class="p-8 pt-4 border-b">
        <h1 class="font-bold pb-4">カラム数</h1>
        <div class="flex flex-col gap-y-2">
          <Select
            v-model="attributes.columnCount"
      ...
      <div class="p-8 pt-4 border-b">
        <h1 class="font-bold pb-4">sp時カラム数</h1>
        <div class="flex flex-col gap-y-2">
          <Select
            v-model="attributes.columnCount"
            :options="columnOptions"
      ...
      <div class="p-8 pt-4 border-b">
        <h1 class="font-bold pb-4">さらに読み込むボタン</h1>
        <div class="flex gap-4">
          <div class="flex items-center">
            <RadioButton
              v-model="attributes.showLoadMore"
              inputId="showLoadMore"
              name="showLoadMore"
              :value="false"
            />
            <label for="placementHeadingPartsNone" class="ml-2 cursor-pointer">
...
onMounted(async () => {
  ...
  api.galleryParts.getCategories().then((res) => {
