<template>
  <template v-if="tab === ''">
    <h1 class="pl-4 font-bold text-xl">メニュー</h1>
  ...
  <template v-if="tab === 'setting'">
    ...
    <div class="px-4 pt-4 pb-4 border-b">
      ...
      <div class="p-8 pt-4 border-b">
        <h1 class="font-bold pb-4">カテゴリ説明文の表示</h1>
        <div class="flex gap-4 flex-wrap">
          <div class="flex items-center">
            <RadioButton
...
onMounted(() => {
  ...
  api.menuParts.getCategories().then(res => {
