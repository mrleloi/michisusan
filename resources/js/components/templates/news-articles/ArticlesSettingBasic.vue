            ...
            <div class="px-[37px]">
                <table class="articles-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.title" class="w-full articles-input" maxLength="35" name="title" placeholder="titleタグに使用されます"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.description" class="w-full articles-input" maxLength="250" name="description" placeholder="meta description 及び関連記事リンクの説明文に使用されます"/>
                                <span class="w-[107px] min-w-[107px] ms-[17px] text-count-char">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.h1_text" class="w-full articles-input" maxLength="35" name="h1_text" placeholder="コンセプト"/>
                                <span class="w-[107px] min-w-[107px] ms-[17px] text-count-char">
            ...
            <div class="px-[37px]">
                <table class="articles-table">
                            ...
                            <div class="flex items-center">
                                <div class="flex w-full max-w-[543px] border rounded-lg border-[#D1D5DB]">
                                    <InputText v-model="tag"
                                               class="w-full articles-input max-w-[494px] input-search-keyword"
                                               @keyup.enter="addTag" maxLength="80" placeholder="タグを入力してください"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.navigation_name" class="w-full articles-input" maxLength="35" name="navigation_name" placeholder="コンセプト"/>
                                <span class="w-[107px] min-w-[107px] ms-[17px] text-count-char">
                    ...
                    <tr>
                        <td class="title">
                            ディレクトリ名<span class="text-[#FF0000] text-[12px] font-semibold">※</span>
                        </td>
                        <td>
                            <div class="flex items-center">
                                <InputText v-model.trim="dataForm.directory" name="directory" class="w-full articles-input max-w-[505px]" placeholder="concept"/>
                            </div>
                            <div class="flex gap-2 items-center mt-[15px]">
                                <label>簡易翻訳 : </label>
                                <InputText v-model.trim="text_translate" class="w-[117px] articles-input"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.keywords" name="keywords" class="w-full articles-input max-w-[543px]" maxLength="80"/>
                            </div>
...
const fetchApiGetTags = async () => {
    ...
    const res = await api.newsArticles.getTags(tagsSelected.value.join(' '))
...
const translate = async () => {
    const res = await api.newsArticles.translate({translate_word: text_translate.value})
