...
const categoryForm = reactive({
    ...
    show_description: props.dataUpdate?.show_description ?? show_description_private,
    h1_text: props.oldInput?.description_heading ?? props.dataUpdate?.description_heading ?? '',
    seleted_text: props.oldInput?.description_heading ?? props.dataUpdate?.description_heading ?? '',
    ...
    link_url: props.dataUpdate?.link_url ?? '',
