...
const dataUpdate = ref(props.dataUpdate)
...
const dataForm = reactive({
    ...
    heading_image: props.oldInput.heading_image ?? '',
    account: props.oldInput.account ?? '',
    password: props.oldInput.password ?? '',
    ...
    show_footer: props.oldInput.showFooter ?? (dataUpdate?.show_footer ? true : false),
    show_footer_logo: props.oldInput.show_header_logo ?? (dataUpdate?.show_footer_logo ? true : false),
    show_footer_navigation_menu: props.oldInput.show_header_navigation_menu ?? (dataUpdate?.show_footer_navigation_menu ? true : false),
    show_footer_sns: props.oldInput.show_footer_sns ?? (dataUpdate?.show_footer_sns ? true : false),
    subnavigation_id: props.oldInput.subnavigation_id ?? '',
    custom_css: props.oldInput.custom_css ?? (dataUpdate?.custom_css || '<pre><code class="language-css"></code></pre>'),
    custom_js: props.oldInput.custom_js ?? (dataUpdate?.custom_js || '<pre><code class="language-javascript"></code></pre>'),
    custom_head_tag: props.oldInput.custom_head_tag ?? (dataUpdate?.custom_head_tag || '<pre><code class="language-html"></code></pre>'),
    publish_status: props.oldInput.publish_status ?? (dataUpdate?.publish_status ?? false),
    ...
    is_template: dataUpdate?.is_template ?? false,
    eye_catch: props.oldInput.eye_catch ?? '',
    simple_top_image_01: props.oldInput.simple_top_image_01 ?? '',
    simple_top_image_02: props.oldInput.simple_top_image_02 ?? '',
    simple_top_image_03: props.oldInput.simple_top_image_03 ?? '',
})
