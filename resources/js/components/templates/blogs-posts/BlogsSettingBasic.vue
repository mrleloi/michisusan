    ...
    <div class="w-full h-full px-3 font-[Inter] mt-6">
        ...
        <form :action="props.path" @submit.prevent="onSubmit" method="post">
            ...
            <div class="border border-[#DFE7EF] px-[25px] py-[21px] rounded-b font-[Inter]">
                <h1 class="text-[22px] font-semibold leading-[33px] mb-2">タイトル・ディスクリプション・h1テキスト</h1>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] pt-[36px] pb-[12px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.page_title" name="page_title" maxLength="35" placeholder="titleタグに使用されます"/>
                        <span class="text-red-500 text-[12px]" v-if="props.errormessage?.page_title?.length">{{props.errormessage?.page_title?.[0]}}</span>
                        <div class="pt-3 flex items-center justify-between">
                            ...
                            <span class="text-right font-semibold">
                                {{ settingForm.page_title ? settingForm.page_title.length : 0 }}文字/35文字
                            </span>
                        </div>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] pt-[28px] pb-[12px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.description" name="description" maxLength="250" placeholder="meta discription及び関連記事リンクの説明文に使用されます"/>
                        <div class="pt-3 flex justify-end">
                            <span class="text-right font-semibold">{{ settingForm.description ? settingForm.description.length : 0 }}文字/250文字</span>
                        </div>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-1">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] pt-[28px] pb-[12px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.h1_text" name="h1_text" maxLength="35" placeholder="ページ上部にあるh1タグテキストに使用されます"/>
                        <div class="pt-3 flex justify-end">
                            <span class="text-right font-semibold">{{ settingForm.h1_text ? settingForm.h1_text.length : 0 }}文字/35文字</span>
                        </div>
                    </div>
                </div>

                <h1 class="text-[22px] font-semibold leading-[33px] mb-2 mt-8">基本設定</h1>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                        <span class="text-base">ナビ表示名</span><span class="text-[#FF0000]">※</span>
                    </div>
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.name" name="name" maxLength="80" />
                ...
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.directory" name="directory" maxLength="80" />
                ...
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model.trim="settingForm.keywords" name="keywords" maxLength="80" placeholder="meta keywordsに使用されます(半角カンマ区切りで入力してください）"/>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[36px] w-full border-l">
                        <span class="font-semibold">独自ドメイン設定後に表示されます</span>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[36px] w-full border-l">
                        ...
                        <input hidden name="per_page" :value="settingForm.per_page">
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] pt-[36px] pb-[16px] w-full border-l">
                        ...
                        <p class="pt-4">一覧ページのサイドカラムは独自cssにて操作してください。</p>
                        <p>タイトルや日付も非表示となります。</p>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                        <span class="text-base">レコメンド（関連記事）</span>
                    </div>
                    <div class="border-[#bdbdbd] px-[18px] py-[36px] w-full border-l">
                        <Checkbox inputId="show_archive" name="show_archive" binary v-model="settingForm.show_archive" />
                        <label class="ml-2" for="show_archive">表示する</label>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                        <span class="text-base">公開日・更新日の表示</span>
                    </div>
                    <div class="border-[#bdbdbd] px-[18px] py-[36px] w-full border-l">
                        <Checkbox inputId="show_published_at" name="show_published_at" binary v-model="settingForm.show_published_at" />
                        <label class="ml-2" for="show_published_at">公開日・更新日を表示しない</label>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0 bg-[#eff3f8]">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] pt-[26px] pb-[12px] w-full border-l">
                        ...
                        <CkEditor
                            ...
                            class="border border-gray-300 rounded-lg p-4 shadow-lg"
                        />
                        <input type="hidden" name="bottom_signature" :value="settingForm.bottom_signature">
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between">
                                <div class="w-1/2 p-1">
                                    ...
                                    <InputText name="account" v-model="settingForm.account" />
                                </div>
                                <div class="w-1/2 p-1">
                                    <label class="mr-2" for="password">パスワード</label>
                                    <InputText name="password" v-model="settingForm.password" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.top_title" name="top_title" maxLength="80" />
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <Textarea class="w-full h-[108px]" v-model="settingForm.top_text" name="top_text"/>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.bottom_title" name="bottom_title" maxLength="80" />
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.bottom_subtitle" name="bottom_subtitle" maxLength="80" />
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <Textarea class="w-full h-[108px]" v-model="settingForm.bottom_text" name="bottom_text"/>
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <h1 class="text-[22px] font-semibold leading-[33px] mt-10">紹介エリア</h1>
                <h2 class="text-[16px] leading-[33px] mb-2">右カラムに表示されます</h2>
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                        <span class="text-base">タイトル</span>
                    </div>
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        <InputText class="w-full h-[38px]" v-model="settingForm.introduction_title" name="introduction_title" maxLength="80" />
                    </div>
                </div>
                <div class="flex items-center border border-[#bdbdbd] border-b-0">
                    <div class="font-semibold flex items-center justify-center w-[260px] min-w-[260px] py-[35px] ">
                ...
                <div class="flex items-center border border-[#bdbdbd] bg-[#eff3f8] border-b">
                    ...
                    <div class="border-[#bdbdbd] px-[18px] py-[28px] w-full border-l">
                        ...
                        <input type="hidden" name="introduction" :value="settingForm.introduction">
                    </div>
                </div>
