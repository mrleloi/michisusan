            ...
            <div class="px-[37px]">
                <table class="posts-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.title" class="w-full posts-input" maxLength="35" name="title" placeholder="titleタグに使用されます"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.description" class="w-full posts-input" maxLength="250" name="description" placeholder="meta description 及び関連記事リンクの説明文に使用されます"/>
                                <span class="w-[107px] min-w-[107px] ms-[17px] text-count-char">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center justify-end">
                                <InputText v-model.trim="dataForm.h1_text" class="w-full posts-input" maxLength="35" name="h1_text" placeholder="コンセプト"/>
                                <span class="w-[107px] min-w-[107px] ms-[17px] text-count-char">
            ...
            <div class="px-[37px]">
                <table class="posts-table">
                            ...
                            <div class="flex items-center">
                                <div class="flex w-full max-w-[543px] border rounded-lg border-[#D1D5DB]">
                                    <InputText v-model="tag"
                                               class="w-full posts-input max-w-[494px] input-search-keyword flex items-center justify-center"
                                               @keyup.enter="addTag" placeholder="タグを入力してください"
                                               maxLength="80"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center">
                                <InputText v-model.trim="dataForm.directory" name="directory" class="w-full posts-input max-w-[505px]" placeholder="concept"/>
                            </div>
