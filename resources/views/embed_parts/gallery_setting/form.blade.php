                ...
                <tr>
                    ...
                    <td>
                        <input-text-with-count name="page_title" class="w-full" :maxlength="35"
                            value="{{ old('page_title', $gallerySetting->page_title ?? '') }}"></input-text-with-count>
                ...
                <tr>
                    ...
                    <td>
                        <input-text-with-count name="description" class="w-full" :maxlength="250"
                            value="{{ old('description', $gallerySetting->description ?? '') }}"></input-text-with-count>
                ...
                <tr>
                    ...
                    <td>
                        <input-text-with-count name="h1_text" class="w-full" :maxlength="35"
                            value="{{ old('h1_text', $gallerySetting->h1_text ?? '') }}"></input-text-with-count>
        ...
        <table class="form-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input-text name="navi_display_name" class="w-full"
                            value="{{ old('navi_display_name', $gallerySetting->navi_display_name ?? '') }}"></input-text>
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="directory_name" class="w-full"
                            value="{{ old('directory_name', $gallerySetting->directory_name ?? '') }}"></input-text>
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="keywords" class="w-full"
                            value="{{ old('keywords', $gallerySetting->keywords ?? '') }}"></input-text>
                            ...
                            @foreach ($naviMenuTypes as $naviMenuType)
                                <div class="w-80">
                                    <pv-checkbox name="navi_menu[{{ $naviMenuType['key'] }}]"
                                        :value="{{ old('navi_menu.' . $naviMenuType['key'], Arr::get($gallerySetting, 'navi_menu.' . $naviMenuType['key']) ?? 0) }}"></pv-checkbox><span
                            ...
                            @foreach ($footerTypes as $footerType)
                                <div class="w-80">
                                    <pv-checkbox name="footer[{{ $footerType['key'] }}]"
                                        :value="{{ old('footer.' . $footerType['key'], Arr::get($gallerySetting, 'footer.' . $footerType['key']) ?? 0) }}"></pv-checkbox><span
                ...
                <tr>
                    ...
                    <td>
                        <image-selector name="header_image_id"
                            value="{{ old('header_image_id', $gallerySetting->header_image_id ?? '') }}"></image-selector>
                    ...
                    <td>
                        <div class="flex flex-wrap">
                            <pv-radio-button name="show_header_image" :options="@js($visibleOptions)"
                                value="{{ old('show_header_image', $gallerySetting->show_header_image ?? '1') }}"></pv-radio-button>
                        </div>
                    ...
                    <td>
                        <div class="flex flex-wrap max-w-[640px] gap-x-10">
                            <radio-button-with-image name="list_design" :options="@js($listlDesignTypes)"
                                value="{{ old('list_design', $gallerySetting->list_design ?? '1') }}">
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex flex-wrap max-w-[640px] gap-x-10">
                            <radio-button-with-image name="detail_design" :options="@js($detailDesignTypes)"
                                value="{{ old('detail_design', $gallerySetting->detail_design ?? '1') }}">
                            </radio-button-with-image>
                        </div>
                        <x-form-error for="detail_design"></x-form-error>
                    </td>
                </tr>
                <tr>
                    <th>詳細ページ</th>
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="show_detail_page" :options="@js($showDetailPageTypes)"
                                value="{{ old('show_detail_page', $gallerySetting->show_detail_page ?? '1') }}"></pv-radio-button>
                        </div>
                        <x-form-error for="show_detail_page"></x-form-error>
                    </td>
                </tr>
                <tr>
                    <th>詳細ページに<br>問い合わせボタン</th>
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="show_inquiry_button" :options="@js($visibleOptions)"
                                value="{{ old('show_inquiry_button', $gallerySetting->show_inquiry_button ?? '1') }}"></pv-radio-button>
                        </div>
                        <x-form-error for="show_inquiry_button"></x-form-error>
                    </td>
                </tr>
                <tr>
                    <th>表示件数</th>
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-select name="number_of_items" :options="@js($numberOfItemsTypes)" class="w-full"
                                ...
                                value="{{ old('number_of_items', $gallerySetting->number_of_items ?? '1') }}"></pv-radio-button>
                        </div>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="number_of_articles" :options="@js($visibleOptions)"
                                value="{{ old('number_of_articles', $gallerySetting->number_of_articles ?? '1') }}"></pv-radio-button>
                        </div>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="category_navi_type" :options="@js($categoryNaviTypes)"
                                value="{{ old('category_navi_type', $gallerySetting->category_navi_type ?? '1') }}"></pv-radio-button>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="show_all_name" class="w-full"
                            value="{{ old('show_all_name', $gallerySetting->show_all_name ?? '') }}"></input-text>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="article_order" :options="@js($articleOrderTypes)"
                                value="{{ old('article_order', $gallerySetting->article_order ?? '1') }}"></pv-radio-button>
                        </div>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-select name="subnavigation" :options="@js($subnavigationTypes)" class="w-full"
                                option-label="label" option-value="key"
                                value="{{ old('subnavigation', $gallerySetting->subnavigation ?? '1') }}"></pv-radio-button>
                        </div>
                        ...
                        <div class="flex gap-5 flex-wrap">
                            <div class="flex flex-nowrap items-center">
                                ...
                                <input-text name="access_limitation_account" class="flex-1 w-44"
                                    value="{{ old('access_limitation_account', $gallerySetting->access_limitation_account ?? '') }}"></input-text>
                            </div>
                            <div class="flex flex-nowrap items-center">
                                <span class="flex-0 w-28">パスワード</span>
                                <input-text name="access_limitation_password" class="flex-1 w-44"
                                    value="{{ old('access_limitation_password', $gallerySetting->access_limitation_password ?? '') }}"></input-text>
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <pv-textarea name="original_head_tag"
                            value="{{ old('original_head_tag', $gallerySetting->original_head_tag ?? '') }}"
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="above_title" class="w-full"
                            value="{{ old('above_title', $gallerySetting->above_title ?? '') }}"></input-text>
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="above_subtitle" class="w-full"
                            value="{{ old('above_subtitle', $gallerySetting->above_subtitle ?? '') }}"></input-text>
                ...
                <tr>
                    ...
                    <td>
                        <pv-textarea name="above_text"
                            value="{{ old('above_text', $gallerySetting->above_text ?? '') }}" rows="3"
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="above_titles_position" :options="@js($positionTypes)"
                                value="{{ old('above_titles_position', $gallerySetting->above_titles_position ?? '1') }}"></pv-radio-button>
                        </div>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="above_text_position" :options="@js($positionTypes)"
                                value="{{ old('above_text_position', $gallerySetting->above_text_position ?? '1') }}"></pv-radio-button>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="below_title" class="w-full"
                            value="{{ old('below_title', $gallerySetting->below_title ?? '') }}"></input-text>
                ...
                <tr>
                    ...
                    <td>
                        <input-text name="below_subtitle" class="w-full"
                            value="{{ old('below_subtitle', $gallerySetting->below_subtitle ?? '') }}"></input-text>
                ...
                <tr>
                    ...
                    <td>
                        <pv-textarea name="below_text"
                            value="{{ old('below_text', $gallerySetting->below_text ?? '') }}" rows="3"
                            class="w-full"></pv-textarea>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="below_titles_position" :options="@js($positionTypes)"
                                value="{{ old('below_titles_position', $gallerySetting->below_titles_position ?? '1') }}"></pv-radio-button>
                        </div>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-x-24">
                            <pv-radio-button name="below_text_position" :options="@js($positionTypes)"
                                value="{{ old('below_text_position', $gallerySetting->below_text_position ?? '1') }}"></pv-radio-button>
                        </div>
