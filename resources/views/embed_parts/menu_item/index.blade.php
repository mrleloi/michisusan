<x-manage.container>
    <x-flash></x-flash>
    <h1 class="text-3xl mb-3">メニュー一覧</h1>
    <div class="border">
        <div class="bg-zinc-200 p-4">
            <form action="{{ route('menu_item.index') }}">
        ...
        <div class="p-4">
            @if ($items->total())
                <form name="bulkdelete" action="{{ route('menu_item.bulk_delete') }}" method="POST"
