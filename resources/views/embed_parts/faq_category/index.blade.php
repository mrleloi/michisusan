    ...
    <div class="w-full h-full px-3">
        ...
        <div class="border">
            <div class="bg-zinc-200 p-4">
                <form action="{{ route('faq_category.index') }}">
            ...
            <div class="p-4">
                @if ($items->total())
                    <form name="bulkdelete" action="{{ route('faq_category.bulk_delete') }}" method="POST"
                        ...
                        <sortable-list :items='@json($items)' :columns='@json($columns)'
                            ...
                            disable-delete='faq_items_count'
                            disable-check='faq_items_count'
