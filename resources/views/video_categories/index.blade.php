<x-manage.container>
    ...
    <div class="border">
        <div class="bg-zinc-200 p-4">
            <form action="{{ route('video_categories.index') }}">
                <div class="flex flex-wrap">
                    ...
                    <div class="flex-1 justify-end flex items-center">
                        <a href="{{ route('video_categories.create') }}">
        ...
        <div class="p-4">
            @if ($items->total())
                <form name="bulkdelete" action="{{ route('video_categories.bulk_delete') }}" method="POST"
        ...
        <script>
            function confirmSubmit() {
                ...
                if (checked.length === 0) {
                    ...
                    return confirm('選択したビデオ カテゴリを削除してもよろしいですか?');
                }
            }
        </script>
    @endpush
